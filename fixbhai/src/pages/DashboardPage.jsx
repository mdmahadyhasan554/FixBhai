    ...
    <div className="d-flex" style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div className="sidebar d-none d-lg-flex flex-column" style={{ width: 240, flexShrink: 0 }}>
        ...
        <div className="p-3 border-top" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
          <button className="nav-link w-100 text-start d-flex align-items-center gap-2 text-danger-emphasis"
        ...
        <div className="bg-white border-bottom px-4 py-3 d-flex align-items-center justify-content-between">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div className="d-lg-none d-flex gap-2">
              {NAV_ITEMS.map(item => (
                <button key={item.key}
                  className={`btn btn-sm ${activeTab === item.key ? 'btn-primary' : 'btn-outline-secondary'} rounded-pill`}
                  onClick={() => setActiveTab(item.key)}>
                  <i className={`bi bi-${item.icon}`} />
                </button>
              ))}
            ...
            <div className="row g-4">
              <div className="col-lg-4">
                <div className="card border-0 shadow-sm rounded-4 p-4 text-center">
                  ...
                  <span className="badge bg-primary rounded-pill px-3">Customer</span>
                </div>
              </div>
              <div className="col-lg-8">
                <div className="card border-0 shadow-sm rounded-4 p-4">
                  ...
                  <button className="btn btn-outline-danger btn-sm rounded-pill mt-4" onClick={handleLogout}>
